...
const Projects = ({state}) => {
        ...
        <section className="project-section">
            ...
            <div className="card-wrapper">
                 {projects!="" && projects.map((project)=>{
                    const githubLink=`https://github.com/fleurdelis07/${project.githubLink}`
 ...
 <Modal size='md' isOpen={modal} toggle={() => setModal(!modal)}>
                    ...
                    {/*  =========popup bootstrap end==========  */}
                    <p className='donate' onClick={() => setModal(true)}>Liked the dummyValue's ? Consider donating Eth's </p>
        </section>
    )
}
